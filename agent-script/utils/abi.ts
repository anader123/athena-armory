export const ZORA_1155_ABI = [
  ...
  { inputs: [], name: "CanOnlyReduceMaxSupply", type: "error" },
  {
    inputs: [
  ...
  { inputs: [], name: "CannotReduceMaxSupplyBelowMinted", type: "error" },
  {
    inputs: [
...
export const ZORA_FACTORY_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "newContractURI", type: "string" },
      { internalType: "string", name: "name", type: "string" },
      { internalType: "address", name: "contractAdmin", type: "address" },
    ],
  ...
  },
  {
    ...
    name: "fixedPriceMinter",
    outputs: [
      { internalType: "contract IMinter1155", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "zora1155Impl",
    outputs: [
      { internalType: "contract IZoraCreator1155", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
